import matkul_semster1 from "./../data/matkulTemplate.js";
...
export default function ScheduleContent1() {
  ...
  try {
    ...
    Object.entries(matkul_semster1).forEach(([day, subjects]) => {
...
function showPopup(subject) {
  ...
  popupContent.innerHTML = `
      <h2 class="text-xl font-bold mb-4">${subject.hari}</h2>
      <p class="mb-2"><strong>Mata Kuliah:</strong> ${subject.mata_kuliah}</p>
